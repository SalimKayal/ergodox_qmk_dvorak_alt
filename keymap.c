 ...
 * |--------+------+------+------+------+------|      |           |      |------+------+------+------+------+--------|
 * | Esc    |   A  |   O  |   W  |   U  |   I  |------|           |------|   D  |   H  |   H  |   N  |S / L2| ~L1/L1 |
 * |--------+------+------+------+------+------|Return|           |Return|------+------+------+------+------+--------|
 * | LShift | Alt/;|   Q  |   J  |   K  |   X  |      |           |      |   B  |   M  |   W  |   V  | Ctl/Z| RShift |
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
...
[BASE] = KEYMAP(  // layer 0 : default
        ...
        KC_LSFT,        ALT_T(KC_SCLN), KC_Q,    KC_J,   KC_K,   KC_X,   KC_ENT,
